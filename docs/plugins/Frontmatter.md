...
This plugin parses the frontmatter of the page using Quartz's built-in frontmatter parser. See [[authoring content#Syntax]], [[Obsidian compatibility]] and [[OxHugo compatibility]] for more information.
