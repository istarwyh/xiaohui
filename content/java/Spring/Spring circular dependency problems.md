...
3. Why can we use constructor injection and lazy loading to solve the circular dependencies? Let's take an example of two classes `ClassA` and `ClassB` with circular dependencies:
