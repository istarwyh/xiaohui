...
注意 Claude Code 默认走的是 Anthropic 协议，但英伟达 NIM 接口(https://integrate.api.nvidia.com/v1) 是兼容 OpenAI 格式的。所以我写了一个代理转发英伟达的OpenAI 接口变成 Antropic的接口协议，
拿到 API key 以后你只需要运行下面命令即可：
