...
- 25 年 6 月～至今，我从事通用 `Agent`（通用智能体）系统建设，并支持百万 `MAU` 的蚂蚁保「保险快查」产品
...
- 在阿里集团奇点学堂分享 `AI Coding` 工具与实战案例，面向蚂蚁保产品团队、蚂蚁保 `BI` 团队分享 `Claude Code` 入门与进阶课程，并建设 [AI Speeds](https://aispeeds.me) 分享 `Claude Code` 最佳实践与超级个体方法
