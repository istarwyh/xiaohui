...
- 25 年 6 月～至今，我从事通用 `Agent`（通用智能体）系统建设，并支持百万 `MAU` 的蚂蚁保「保险快查」产品，推进产品解读报告、质量评分和产品评测等 `Agent` 生产链路落地
- 24 年 12 月～25 年 6 月，我负责蚂蚁保保险科技的[[如何快速创建领域Agent - OneAgent + MCPs 范式|MCP 相关工作]]
- 24 年 6 月～11 月，我负责蚂蚁保风控 `AI Agent` 驱动的 [[Case Analysis AI Agent|案件分析]] 工作
...
- 给 `AgentUniverse` 开源项目提交 [#202 PR](https://github.com/agentuniverse-ai/agentUniverse/pull/202)，获得蚂蚁开源轻训营-最佳贡献奖
...
- 通用 `Agent` 系统、语聊机器人和 `AI Agent` 产品落地经验
- 财务后端开发的专业经验
