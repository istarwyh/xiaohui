...
Component.CardFeed({
  cards: [
    ...
    { title: "CLAUDE", slug: "CLAUDE", imageUrl: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop&q=80" },
    { title: "Agent Teams 的原理与实践", slug: "program/bot/Agent-Teams-的原理与实践", imageUrl: "https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?w=800&h=600&fit=crop&q=80" },
    { title: "how to use termux on android", slug: "life/experience/how-to-use-termux-on-android", imageUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&h=600&fit=crop&q=80" }
  ]
})
-->
