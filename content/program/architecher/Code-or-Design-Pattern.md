...
- 超大方法
- 重复代码
- 扩展性差: 新增需求代码多处修改 ......可谓是“好的代码总是千篇一律，不好的代码各有各的不好”。总结起来，影响代码质量差的原因有几类：
...
4. 打磨重构自己的代码 ![](https://xiaohui-zhangjiakou.oss-cn-zhangjiakou.aliyuncs.com/image/202405290851575.png)
...
面向切面封装识别功能的收益，埋点、报表、同比环比等等。面向切面做缓存
...
- 对象的数量？
- 对象的展示？
- 对象的关系：链表、树、图状？因为解决的对象变化问题不同，设计模式才会分为创建型、结构型和行为型。
...
配置项、接口、类、注解、插件等等。下面再介绍一些具体的设计模式（套路）。
