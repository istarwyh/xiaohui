...
这里要继续往下追问一层：用户买的通常不是功能、技术或者 `UI`，而是功能背后带来的情绪结果。赚钱的产品看起来在满足需求，实际上是在帮用户处理焦虑、欲望、恐惧、希望和身份认同。

从这个角度看，很多产品可以被简单归到几类：

| 底层驱动力 | 用户真正想要的情绪结果 | 常见产品形态 |
| --- | --- | --- |
| 变有钱 | 对未来更安全，对资源更有控制感 | 记账、预算、理财、财务管理 |
| 变漂亮 | 被喜欢、被看见、被更好地评价 | 护肤记录、减肥、美颜、穿搭 |
| 变聪明 | 减少无知带来的不安，获得理解世界的能力 | 学习、阅读、知识管理 |
| 有掌控感 | 对混乱生活重新建立秩序 | 时间管理、任务管理、计划工具 |
| 减轻焦虑 | 从高压状态里获得缓冲和安放 | 冥想、白噪音、日记、情绪记录 |
| 获得认同 | 证明自己正在进步，并被他人看见 | 徽章、打卡、排行榜、社群激励 |

所以需求分析不能停在“用户需要一个什么功能”，而要问：这个功能让用户感觉自己变成了什么人？逃离了什么处境？获得了哪种确定性？这和 [[自媒体内容产品]] 里说的内容价值类似，用户消费的往往不是外壳，而是理解、判断、情绪、陪伴、身份感，或者替他说话的能力。
