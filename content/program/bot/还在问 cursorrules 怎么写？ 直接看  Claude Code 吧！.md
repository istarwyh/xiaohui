...
![](https://xiaohui-zhangjiakou.oss-cn-zhangjiakou.aliyuncs.com/image/202507201515678.png)
...
![](https://xiaohui-zhangjiakou.oss-cn-zhangjiakou.aliyuncs.com/image/202507201501277.png)
7. Claude 响应 Code Review 意见，点评后修复

![](https://xiaohui-zhangjiakou.oss-cn-zhangjiakou.aliyuncs.com/image/202507201516392.png)
...
**创建命令**：
在 `.claude/commands/` 目录下创建 Markdown 文件。可以在 家目录下或者当前项目下。
...
![](https://xiaohui-zhangjiakou.oss-cn-zhangjiakou.aliyuncs.com/image/202507201749933.png)
```
---
...
### 3.2 测试驱动开发（TDD）
相比让 AI 先写功能再写测试，在项目有条件先写测试再写功能的时候，因为 AI 有一个明确的迭代目标（让测试通过），AI 表现更好，用户也方便验收。不过要完全驾驭 AI + TDD，也是有点难度。
验证时需要明确告诉 AI 我们正在做 TDD，需要红绿循环。当所有测试通过后，最好再开启一个独立的 Agent 去检查测试是否过拟合了。以下是一个伪Prompt: 
...
值得一提的是，让 LLM 更多地思考还有很多方法，比如使用 `<think>` 的COT和 few-shot , 或者使用 sequential-thinking MCP。
...
![](https://xiaohui-zhangjiakou.oss-cn-zhangjiakou.aliyuncs.com/image/202507201813266.png)
...
输入参数参见官方文档：https://docs.anthropic.com/en/docs/claude-code/hooks
#### 1. PreToolUse Hook
