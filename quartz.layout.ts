    ...
    Component.ConditionalRender({
      component: Component.CardFeed({
        cards: [
          ...
          { title: "晓灰的端到端测试实践", slug: "program/full-stream/晓灰的端到端测试实践", imageUrl: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop&q=80" },
          { title: "我如何做到 100% AI 编程", slug: "program/full-stream/我如何做到-100-percent-AI-编程", imageUrl: "https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?w=800&h=600&fit=crop&q=80" },
          { title: "JUnit5 & Mockito", slug: "program/full-stream/Test/JUnit5--and--Mockito", imageUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&h=600&fit=crop&q=80" },
        ],
      }),
      condition: (page) => page.fileData.slug === "index",
    }),
