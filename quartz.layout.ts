    ...
    Component.ConditionalRender({
      component: Component.CardFeed({
        cards: [
          ...
          { title: "如何放心 100% AI 交付需求 (1)    端到端测试", slug: "program/full-stream/如何放心-100-percent-AI-交付需求-(1)----端到端测试", imageUrl: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&h=600&fit=crop&q=80" },
          { title: "如何放心 100% AI 交付需求(3)    开发如同玩游戏", slug: "program/full-stream/如何放心-100-percent-AI-交付需求(3)----开发如同玩游戏", imageUrl: "https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?w=800&h=600&fit=crop&q=80" },
          { title: "如何放心 100% AI 交付需求(2)    Loop 与 Agent Loop", slug: "program/full-stream/如何放心-100-percent-AI-交付需求(2)----Loop-与-Agent-Loop", imageUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&h=600&fit=crop&q=80" },
        ],
      }),
      condition: (page) => page.fileData.slug === "index",
    }),
